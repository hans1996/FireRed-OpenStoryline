...
Auto-generated on 2026-04-07. This roadmap tracks improvements for the fork repo.
...
- [ ] #3 — Add ruff/pylint to CI and enforce linting on PRs
- [ ] #4 — Add pytest integration test to CI
- [ ] #5 — Add CONTRIBUTING.md
- [ ] #6 — Add CODE_OF_CONDUCT.md

## Tests (P0 — Critical)

- [ ] #7 — Add test for agent_fastapi.py ChatSession lifecycle
- [ ] #8 — Add test for MCP server / sampling handler
- [ ] #9 — Add test for node_manager (node registration and execution order)
- [ ] #10 — Add test for plan_timeline nodes (AI + Pro variants)
- [ ] #11 — Add test for ffmpeg_utils
- [ ] #12 — Add test for media_handler
- [ ] #13 — Add test for session_manager and agent_memory
- [ ] #14 — Add test for skills_io
- [ ] #15 — Add test for all node input/output schemas
- [ ] #16 — Add test for config loading (config.toml + .env)
- [ ] #17 — Add test for webhook / AI transition client
- [ ] #18 — Add test for CLI entry points

## Code Quality (P1)

- [ ] #19 — Implement compress_log parameter in node_summary (marked as TODO)
- [ ] #20 — Review and fix all 33 TODO/FIXME/HACK comments in the codebase
- [ ] #21 — Add type hints to agent_fastapi.py (currently minimal typing)
- [ ] #22 — Add type hints to cli.py
...
- [ ] #33 — Add API documentation (OpenAPI/Swagger for FastAPI endpoints)
...
- [ ] #40 — Ensure .env is never committed (add to .gitignore if missing)
...
- [ ] #50 — Add pre-commit hook config (pre-commit.yaml)
- [ ] #51 — Add editorconfig for consistent formatting
- [ ] #52 — Remove unused files from __pycache__/
- [ ] #53 — Clean up .env.example with all required variables
